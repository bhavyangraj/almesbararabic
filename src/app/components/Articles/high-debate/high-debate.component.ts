...
@Component({
  ...
  templateUrl: './high-debate.component.html',
  styleUrl: './high-debate.component.css',
})
export class HighDebateComponent implements OnInit {
  interviews: any[] = [];
  page = 1;
  pageSize = 10;
  ...
  openInNewTab(id: string) {
    this.router.navigate(['/highdebate/' + id]);
  }
  ...
  getName() {
    return this.apiService.getArabicName('highdebate');
  }
